...
export const metadata: Metadata = {
  title: "Statement of Purpose — Arsalan Ayaz | Stanford Application",
  description: "Statement of Purpose for Stanford University fully funded scholarship application by Arsalan Ayaz — AI, Machine Learning, and Computational Chemistry for Medicine & Public Health.",
};
...
export default function StatementOfPurpose() {
  return (
    <div className="min-h-screen font-sans flex flex-col pt-8">
      {/* Header Banner */}
      <div className="w-full max-w-[1200px] mx-auto bg-gradient-to-r from-[#2c1d11] via-[#5c3e23] to-[#8c5e35] relative px-8 md:px-12 py-10 shadow-sm">
        <div className="absolute inset-0 bg-black/20 mix-blend-multiply"></div>
        <div className="relative z-10">
          <Link href="/" className="text-white/70 text-[11px] font-bold tracking-widest uppercase hover:text-white transition-colors mb-4 inline-block">
            ← Back to Profile
          </Link>
          <h1 className="text-3xl md:text-[38px] font-bold text-white mb-2 font-sans tracking-tight leading-tight">
            Statement of Purpose
          </h1>
          <h2 className="text-[11px] md:text-[13px] font-bold text-gold tracking-widest uppercase">
            Stanford University — Fully Funded Graduate Scholarship Application
          </h2>
        </div>
      </div>

      {/* SOP Content */}
      <div className="flex-1 w-full max-w-[1200px] mx-auto bg-white shadow-sm mb-12">
        <article className="p-8 md:p-16 max-w-[800px]">
          ...
          <div className="mb-10 pb-8 border-b border-gray-200">
            <div className="grid grid-cols-[120px_1fr] gap-y-1.5 text-[14px] text-[#4d4f53]">
              ...
              <span>Graduate Studies — AI for Medicine & Public Health</span>
          ...
          <section className="mb-10">
            ...
            <p className="text-[#4d4f53] text-[15px] leading-[1.85] mb-4">
              ...
              to contribute to this frontier. My goal is to pursue fully funded graduate studies at Stanford University, where I 
            ...
            <p className="text-[#4d4f53] text-[15px] leading-[1.85]">
              I am drawn to Stanford not only for its world-class faculty and research infrastructure, but also for its 
              deeply collaborative culture that transcends disciplinary boundaries. Stanford&apos;s commitment to using technology 
              for global impact aligns precisely with my aspiration: to bridge computational innovation with real-world 
              health outcomes.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-[#4d4f53] text-[15px] leading-[1.85]">
              I envision contributing to the following research directions at Stanford:
            </p>
          ...
          {/* Section 4: Why Stanford */}
          <section className="mb-10">
            <h3 className="text-2xl text-cardinal mb-4 font-normal">Why Stanford?</h3>
            <p className="text-[#4d4f53] text-[15px] leading-[1.85] mb-4">
              Stanford University occupies a singular position in my aspirations for several compelling reasons:
            </p>
            <ul className="space-y-3 ml-6 mb-4">
              <li className="text-[#4d4f53] text-[14px] leading-relaxed flex items-start">
                <span className="text-cardinal mr-2 text-[10px] mt-[5px]">■</span>
                <div>
                  <strong>Interdisciplinary Culture:</strong> Stanford&apos;s unique structure encourages collaboration across 
                  departments — from the School of Medicine and the Department of Chemistry to the Institute for 
                  Human-Centered AI (HAI). This is exactly the environment I need to synthesize my chemistry background 
                  with AI research.
                </div>
              </li>
              <li className="text-[#4d4f53] text-[14px] leading-relaxed flex items-start">
                <span className="text-cardinal mr-2 text-[10px] mt-[5px]">■</span>
                <div>
                  <strong>World-Class Faculty:</strong> Researchers at Stanford are leading some of the most exciting work 
              ...
              <li className="text-[#4d4f53] text-[14px] leading-relaxed flex items-start">
                <span className="text-cardinal mr-2 text-[10px] mt-[5px]">■</span>
                <div>
                  <strong>Global Impact Orientation:</strong> Stanford&apos;s emphasis on translating research into societal 
              ...
              <li className="text-[#4d4f53] text-[14px] leading-relaxed flex items-start">
                ...
                <div>
                  ...
                  a preference — it is a necessity. Stanford&apos;s commitment to supporting talented students from diverse 
                  backgrounds and ensuring that financial constraints do not limit intellectual potential is a value I deeply respect.
                </div>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            <h3 className="text-2xl text-cardinal mb-4 font-normal">What I Bring to Stanford</h3>
            <p className="text-[#4d4f53] text-[15px] leading-[1.85] mb-4">
              I bring to Stanford a rare combination of competencies:
            </p>
            ...
            <p className="text-[#4d4f53] text-[15px] leading-[1.85]">
              ...
              passion for global health — will enable me to make meaningful contributions to Stanford&apos;s research community 
          ...
          <section className="mb-10">
            ...
            <p className="text-[#4d4f53] text-[15px] leading-[1.85] mb-4">
              Upon completing my graduate studies at Stanford, I aspire to:
            </p>
            <ul className="space-y-2 ml-6 mb-4">
              <li className="text-[#4d4f53] text-[14px] leading-relaxed flex items-start">
                <span className="text-cardinal mr-2 text-[10px] mt-[5px]">■</span>
          ...
          <section className="mb-10">
            ...
            <p className="text-[#4d4f53] text-[15px] leading-[1.85] mb-6">
              I respectfully request the opportunity to pursue my graduate studies at Stanford University with full 
